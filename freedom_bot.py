...
SESSIONS = {
    ...
    "NY_REVERSAL":    {"h": (18.0, 23.0), "icon": "🔄", "sweep_pct": 0.001, "size_mult": 1.5, "scalp": True},
...
CONFIG = {
    ...
    "ETH_USDT": {
        "icon": "🔵", "active": True,
        "min_moonbag": 0, "dca_levels": 5, "grid_step": 0.012,
        "max_contracts": 14,           # SOL wyłączony → więcej marginu dla ETH
        "risk_per_level": 0.015,       # 1.5% equity per level (było 1%, SOL nieaktywny)
        "tp_pct": 0.02, "tp_pct_from_now": 0.04, "trailing_trigger": 0.03,
